...
class AVFDetectorApp:
    ...
    def create_live_detection_screen(self):
        ...
        # Header with gradient effect using frame layering
        ...
        # Result display with border - smaller
    ...
    def create_recording_screen(self):
        ...
        # Status display with border - smaller
    ...
    def create_file_scanner_screen(self):
        ...
        self.file_result_frame = tk.Frame(result_container, bg='#95a5a6', height=75)
        ...
        # Separator
        separator1 = tk.Frame(content, bg='#bdc3c7', height=1)
        separator1.pack(fill='x', pady=8)
        
        # Details section in a frame - more compact
        details_container = tk.Frame(content, bg='#ecf0f1', bd=1, relief='solid')
        details_container.pack(fill='x', pady=5)
        
        details_frame = tk.Frame(details_container, bg='#ecf0f1')
        details_frame.pack(fill='x', padx=8, pady=5)
        
        # Duration
        dur_frame = tk.Frame(details_frame, bg='#ecf0f1')
        dur_frame.pack(fill='x', pady=2)
        tk.Label(dur_frame, text="Duration:", font=("Helvetica", 9, "bold"), 
                bg='#ecf0f1', fg='#2c3e50', width=11, anchor='w').pack(side='left', padx=(0, 8))
        self.file_duration_label = tk.Label(dur_frame, text="30 secs", font=("Helvetica", 9),
                                           bg='#ecf0f1', fg='#2c3e50', anchor='e')
        #self.file_duration_label.pack(side='right')
        
        # Segments
        seg_frame = tk.Frame(details_frame, bg='#ecf0f1')
        seg_frame.pack(fill='x', pady=2)
        tk.Label(seg_frame, text="Segments:", font=("Helvetica", 9, "bold"),
                bg='#ecf0f1', fg='#2c3e50', width=11, anchor='w').pack(side='left', padx=(0, 8))
        self.file_segments_label = tk.Label(seg_frame, text="10", font=("Helvetica", 9),
                                            bg='#ecf0f1', fg='#2c3e50', anchor='e')
        #self.file_segments_label.pack(side='right')
        
        # Consistency
        cons_frame = tk.Frame(details_frame, bg='#ecf0f1')
        cons_frame.pack(fill='x', pady=2)
        tk.Label(cons_frame, text="Consistency:", font=("Helvetica", 9, "bold"),
                bg='#ecf0f1', fg='#2c3e50', width=11, anchor='w').pack(side='left', padx=(0, 8))
        self.file_consistency_label = tk.Label(cons_frame, text="99.2%", font=("Helvetica", 9),
                                               bg='#ecf0f1', fg='#2c3e50', anchor='e')
        #self.file_consistency_label.pack(side='right')
        
        # Confidence
        conf_frame = tk.Frame(details_frame, bg='#ecf0f1')
        conf_frame.pack(fill='x', pady=2)
        tk.Label(conf_frame, text="Confidence:", font=("Helvetica", 9, "bold"),
                bg='#ecf0f1', fg='#2c3e50', width=11, anchor='w').pack(side='left', padx=(0, 8))
        self.file_confidence_label = tk.Label(conf_frame, text="95.0%", font=("Helvetica", 9),
                                              bg='#ecf0f1', fg='#2c3e50', anchor='e')
        #self.file_confidence_label.pack(side='right')
        
        # Separator
        separator2 = tk.Frame(content, bg='#bdc3c7', height=1)
        separator2.pack(fill='x', pady=8)
        
        # Current Audio - smaller
            ...
            if default_input:
                ...
                for rate in supported_rates:
                    try:
                        ...
                        self.live_buffer_size = rate * 3  # 3 seconds
    ...
    def _recording_complete(self, filename):
        ...
        self.rec_status_label.config(text="NOT RECORDING", bg='#e74c3c', 
                                     fg='#f5b7b1')
    ...
    def select_audio_file(self):
        ...
        # Create file selection dialog - matches the modal in the images
        dialog = tk.Toplevel(self.window)
        ...
        try:
            ...
            if len(wav_files) == 0:
                ...
                for filepath in wav_files:
                    ...
                    file_label = tk.Label(
                        scrollable_frame,
                        text=filepath.name,  # Show actual filename
                        font=("Helvetica", 12),
                        bg='white',
                        fg='#2c3e50',
                        anchor='w',
    ...
    def _show_file_results(self, result):
        ...
        self.file_duration_label.config(text=f"{result['duration']:.1f} secs")
        self.file_segments_label.config(text=str(result['num_segments']))
        self.file_consistency_label.config(text=f"{result['consistency']:.1%}")
        self.file_confidence_label.config(text=f"{confidence:.1f}%")
        
        # Show completion message dialog matching images
