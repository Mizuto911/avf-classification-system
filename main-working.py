...
class StenosisTester:
    ...
    def __init__(self):
        ...
        self.mic_device_id = 1  # INMP441 device ID
        self.recording_duration = 30  # Fixed 30 seconds recording
        self.mic_sample_rate = 48000  # I2S microphone sample rate
        
        # Live detection parameters
        self.is_live_detecting = False
        self.audio_queue = queue.Queue()
        self.live_buffer = []
        self.live_buffer_size = 48000 * 3  # 3 seconds at 48kHz
    ...
    def setup_ui(self):
        ...
        confidence_score_frame.pack(fill='x', pady=3)
    ...
    def load_model(self):
        ...
        try:
            ...
            try:
                ...
                mic_name = devices[self.mic_device_id]['name']
                mic_status = f"Microphone: {mic_name}"
            except:
                mic_status = "Microphone: Not detected"
            
            self.status_label.config(
                text="Model loaded successfully - Ready for live detection or file analysis",
                bg='#27ae60'
            )
            self.info_label.config(
                text=f"Model: Loaded\nScaler: Loaded\n{mic_status}\nStatus: Ready\n\nStart live detection or select a file."
            )
    ...
    def start_live_detection(self):
        ...
        try:
            self.stream = sd.InputStream(
                ...
                blocksize=4800,  # Process 0.1 second chunks at 48kHz
                dtype='float32'
            )
            self.stream.start()
    ...
    def start_recording(self):
        ...
        # self.recording_duration is now fixed at 30 seconds
    ...
    def select_file(self):
        ...
        try:
            ...
            if len(wav_files) == 0:
                ...
                # Create cards in grid (2 columns)
                row = 0
                col = 0
