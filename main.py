...
class AVFDetectorApp:
    ...
    def setup_ui(self):
        ...
        live_btn = tk.Button(
            live_btn_frame, text="Live\nDetection", font=("Helvetica", 9),
        ...
        rec_btn = tk.Button(
            rec_btn_frame, text="Recording", font=("Helvetica", 9),
            bg='#2c3e50', fg='white', activebackground='#34495e', bd=0,
            relief='flat', cursor="hand2", width=10, height=3,
    ...
    def create_live_detection_screen(self):
        ...
        tk.Label(header, text="Real Time Monitoring", font=("Helvetica", 16, "bold"),
        ...
        tk.Label(self.live_result_frame, text="Analysis Results", font=("Helvetica", 10, "bold"),
                 bg='#95a5a6', fg='white').pack(pady=(5, 2))
        
        self.live_result_label = tk.Label(self.live_result_frame, text="NOT STARTED",
        ...
        tk.Label(instructions_frame,
                 ...
                 font=("Helvetica", 10), bg='#ecf0f1', fg='#2c3e50', justify='center',
                 pady=10).pack()
        
        self.live_control_btn = tk.Button(
            content, text="Start Live Detection", font=("Helvetica", 12, "bold"),
            bg='#27ae60', fg='white', activebackground='#229954', bd=0,
            command=self.toggle_live_detection, cursor="hand2", width=20, height=1, pady=8
        )
    ...
    def create_recording_screen(self):
        ...
        header.pack(fill='x')
        header.pack_propagate(False)
        tk.Label(header, text="Recording Session", font=("Helvetica", 16, "bold"),
                 bg='#6b7db5', fg='white').pack(expand=True, pady=10)
        ...
        tk.Label(self.rec_status_frame, text="Status", font=("Helvetica", 10, "bold"),
                 bg='#e74c3c', fg='white').pack(pady=(5, 2))
        
        self.rec_status_label = tk.Label(self.rec_status_frame, text="NOT RECORDING",
                                         font=("Helvetica", 22, "bold"), bg='#e74c3c', fg='#f5b7b1')
        self.rec_status_label.pack(expand=True, pady=(0, 5))
        
        style = ttk.Style()
        style.theme_use('default')
        style.configure("rec.Horizontal.TProgressbar", troughcolor='#d5d8dc', bordercolor='#d5d8dc',
                        background='#27ae60', lightcolor='#27ae60', darkcolor='#27ae60', thickness=18)
        ...
        self.rec_instructions = tk.Label(
            ...
            font=("Helvetica", 9), bg='#ecf0f1', fg='#2c3e50', justify='center', pady=8
        )
        self.rec_instructions.pack()
        
        self.rec_control_btn = tk.Button(
            content, text="Start Recording", font=("Helvetica", 12, "bold"),
            bg='#27ae60', fg='white', activebackground='#229954', bd=0,
            command=self.toggle_recording, cursor="hand2", width=20, height=1, pady=8
        )
    ...
    def create_file_scanner_screen(self):
        ...
        tk.Button(button_frame, text="Select Audio", font=("Helvetica", 11, "bold"),
                  bg='#34495e', fg='white', activebackground='#2c3e50', bd=0,
                  command=self.select_audio_file, cursor="hand2", width=14, height=1,
    ...
    def start_live_detection(self):
        ...
        self.live_control_btn.config(text="Stop Live Detection", bg='#e74c3c', activebackground='#c0392b')
        self.live_result_frame.config(bg='#f39c12')
        self.live_result_label.config(text="Listening...", bg='#f39c12')
        
        try:
            self.stream = sd.InputStream(
                samplerate=self.mic_sample_rate, channels=1, device=self.mic_device_id,
                callback=self.audio_callback, blocksize=int(self.mic_sample_rate * 0.1), dtype='float32'
            )
            self.stream.start()
        ...
        while self.is_live_detecting:
            try:
                ...
                if len(self.live_buffer) >= self.live_buffer_size:
                    ...
                    audio_resampled = librosa.resample(audio_segment, orig_sr=self.mic_sample_rate,
    ...
    def stop_live_detection(self):
        ...
        if hasattr(self, 'stream'):
            self.stream.stop()
            self.stream.close()
        self.live_control_btn.config(text="Start Live Detection", bg='#27ae60', activebackground='#229954')
    ...
    def start_recording(self):
        ...
        self.rec_control_btn.config(text="Stop Recording", bg='#e74c3c', activebackground='#c0392b')
        self.rec_status_frame.config(bg='#27ae60')
        self.rec_status_label.config(text="RECORDING", bg='#27ae60', fg='white')
        self.rec_instructions.config(text="Recording Accoustic\nVibration\n\nA 30 second recording session\ncurrently in progress.")
    ...
    def _recording_complete(self, filename):
        self.is_recording = False
        self.rec_control_btn.config(text="Start Recording", bg='#27ae60', activebackground='#229954')
        ...
        self.rec_instructions.config(text=f"Recording Complete!\n\n{filename}\n\nGo to File Scanner to analyze")
    ...
    def select_audio_file(self):
        ...
        tk.Label(dialog, text="Recording List", font=("Helvetica", 16, "bold"),
